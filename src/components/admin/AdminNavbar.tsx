...
const NAV_LINKS = [
  ...
  { href: '/admin/interview', label: 'Knowledge test' },
];

/** Routes that operate on a single applicant and need the picker. */
const CANDIDATE_ROUTES = ['/admin/checklist', '/admin/interview'];
...
export function AdminNavbar() {
  ...
  useEffect(() => {
    const fromUrl = new URLSearchParams(window.location.search).get('candidate');
  ...
  return (
    <header className={styles.navbar}>
      <Link href="/admin/vetting" className={styles.brand} aria-label="BA Express — Admin home">
        <Image
